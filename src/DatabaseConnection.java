...
public class DatabaseConnection {     // Definiert eine öffentliche Klasse namens DatabaseConnection
    private static final String URL = "jdbc:mysql://localhost:3306/fahrzeugverwaltung2"; // URL zur Datenbank
